...
class ARS(object):
    ...
    def update(self, schema, entry_id, entry_values):
        ...
        for field_name, value in entry_values.items():
            ...
            field_value_list.fieldValueList[0].fieldId = field_id
            field_value_list.fieldValueList[0].value.dataType = (
            ...
            field_value_list.fieldValueList[0].value.u.charVal.data = (
